<!-- ====== Modal Section Start -->
  ...
  >
    <div
      @click.outside="modalFilter = false"
    ...
    >
      ...
      <div class="space-y-6">
        ...
        <option value=""  class="font-bold text-black ">Select a category</option>
        ...
        <select wire:model="selectedGenre" class="bg-yellow-600 text-white py-5 px-10 hover:bg-amber-600 rounded cursor-pointer">
        <option value=""  class="font-bold text-black ">Select a Genre</option>
      ...
      <div class="mt-12 flex justify-center space-x-4">
        ...
        <button
        @click="modalFilter = false"
        class="bg-emerald-400 text-white px-4 py-2 text-center text-base font-medium rounded transition hover:bg-emerald-500"
                wire:click="save">
          Save
        </button>
      </div>
