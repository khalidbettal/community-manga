    ...
    <!-- div number two -->
        ...
        <div class="justify-center  flex-1 max-w-4xl w-auto py-4  text-left  ">
            ...
            @if (!empty($post->image))
                ...
                <div class=" max-w-4xl  px-6 pt-6 md:pb-2 mx-auto rounded-lg  shadow-sm grid grid-cols-1 bg-white dark:bg-gray-900  mb-6 lg:grid-cols-[1fr,70%]   gap-6 before:">
                   ...
                   <img src="{{ url('storage/posts/' . $post->image) }}" alt="Post Image"
                    ...
                    <div class="px-4 py-4 lg:px-0">
                        ...
                        <!-- Post title -->
                        <a href="#">
                            <h2 class="mt-3 mb-3 text-2xl font-bold hover:underline dark:text-white">
                 ...
                 @endif
                 <span>
			     <a rel="noopener noreferrer" href="{{ route('post.single', ['slug' => $post->slug]) }}" class="hover:underline text-blue-500 dark:text-violet-400">...Read more</a>
		...
		<div class="flex items-center justify-between">
		   ...
		   <div class="mt-3">
			<a rel="noopener noreferrer" href="{{ route('post.single', ['slug' => $post->slug]) }}" class="text-2xl font-bold hover:underline">{{ $post->title }}</a>
			<p class="m-3 text-sm text-gray-500 dark:text-gray-400">
                    @if (Str::length($post->description) > 100)
                       <span class="hidden lg:inline">
